...
DROP TABLE DASHBOARD_HRMUSERS;

DROP TABLE DASHBOARD_HRMUSERS_USER_PE38B6;
...
why cnams was made , objectives of the unit
reason why nams was required to be made.... 
