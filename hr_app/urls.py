...
urlpatterns = [
    ...
    path('edit_commission/<int:personnel_id>',IhqViews.edit_commission, name="edit_commission"),
    ...
    path('manage_transfer_page',IhqViews.manage_transfer_page, name="manage_transfer_page"),
    ...
    path('manage_transfer_action/',IhqViews.manage_transfer_action, name="manage_transfer_action"),
    ...
    path('officers_marked_for_transfer', IhqViews.officers_marked_for_transfer, name="officers_marked_for_transfer"),
    path('edit_transfer',IhqViews.edit_transfer,name = "edit_transfer")
]